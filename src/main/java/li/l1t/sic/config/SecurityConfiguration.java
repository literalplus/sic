...
import li.l1t.sic.security.auth.JwtAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth
                ...
                .usersByUsernameQuery("SELECT username,password,enabled FROM sic_user WHERE username=?")
                .authoritiesByUsernameQuery("SELECT username, authority FROM sic_authority WHERE username=?");
    }
